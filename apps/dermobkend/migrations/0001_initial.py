# Generated by Django 4.1.5 on 2023-02-16 05:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('CREADO', 'Creado'), ('EREVISION', 'Revision'), ('RECLAMADO', 'Seleccionado'), ('DIAGNOSTICADO', 'Diagnosticado')], max_length=50)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('institucion_educativa', models.TextField(max_length=150)),
                ('nombre_programa', models.TextField(max_length=150)),
